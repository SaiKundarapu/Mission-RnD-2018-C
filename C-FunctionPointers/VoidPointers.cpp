...
void typeCastToAllDataTypes(void * long_ptr, void * float_ptr, void * char_ptr, void * str_ptr)
{
	...
	printf("Value stored at char_ptr is  %c", *(char *)char_ptr);
	printf("Value stored at string_ptr is  %s", *(char *)str_ptr);
}
...
void task7() 
{
	...
	printf("Value stored at float is  %f\n", *(float *)getFloatAsVoidStar());
	printf("Value stored at int is  %f\n", *(int *)getIntAsVoidStar());
	printf("Value stored at string is  %f\n", *(char *)getStringAsVoidStar());
}
